...
public class HabilidadFisica extends Habilidad{
    ...
    public HabilidadFisica(int id, String nombre, String descripcion, CategoriaHabilidad categoria, List<DiciplinaHabilidad> diciplinas, List<Elementos> elementos, List<EfectosEstado> efectos, int cooldown, int duracion, int rango, double costoVida, boolean requerimiento, double atcFisico, int costeEnergia) {
    ...
    public void DetallesHabilidad() {
        System.out.println("=== Detalles de la Habilidad Física ===");
